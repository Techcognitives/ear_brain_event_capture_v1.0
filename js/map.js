...
function clickCognivePreferred(practiceName, firstLast, fullStreet, fullAddress, phoneNumber) {
    $("#locations .preffered-list").removeClass("selectedmap")
    infowindow.close();
    var formData = {practiceName:practiceName,firstLast:firstLast, fullStreet:fullStreet, fullAddress:fullAddress, phoneNumber:phoneNumber, email:emailID}; 
...
function clickCogniveOtherPreferred(practiceName, firstLast, fullStreet, fullAddress, phoneNumber) {
    $("#locations .preffered-list").removeClass("selectedmap");
    infowindow.close();
    var formData = {practiceName:practiceName,fullStreet:fullStreet, fullAddress:fullAddress, email:emailID }; 
...
function clickAnAudiologistSubmit() {
    ...
    if (!isChecked) {
        if (yourAudiologist == "") {
            ...
            var formData = {yourAudiologist:yourAudiologist,practiceName:practiceName, iDontHaveAnAudiologist:false, email:emailID }; 
        ...
        var formData = {iDontHaveAnAudiologist:true, email:emailID }; 
        captureEventCanNotFindTheAUD(formData)
        var login = document.querySelector(".login");
        login.classList.toggle("show-modal");
        $('#practiceName').val("")
